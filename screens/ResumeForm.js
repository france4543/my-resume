...
import {View,StyleSheet,Text,TextInput, Button, Alert, Platform , ScrollView} from 'react-native'
    ...
    render(){
        return(
            <ScrollView style={styles.container}>
                ...
                <Camera onTakePicture = {(pictuerUri) => {this.setState({ avatar: pictuerUri})}} />
                </View>
                <View>
                    <Text>Full name</Text>
                    <TextInput 
